...
3. Create an `orm.js` file inside `config` directory.
   ...
   * In the `orm.js` file,cd create the methods that will execute the necessary MySQL commands in the controllers. These are the methods you will need to use in order to retrieve and store data in your database.
